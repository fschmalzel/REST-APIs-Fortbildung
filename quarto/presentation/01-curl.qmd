...
```bash
curl \
  https://rest.fschmalzel.de/api/v1/public/messages \
  -X POST \
...
Basis-URL: `https://rest.fschmalzel.de/api/v1/public/messages`
Message Board ansehen: <https://rest.fschmalzel.de/board/public>
**Aufgaben:**

1. Ruft alle Nachrichten ab (GET) – was fällt am Response auf? 
2. Schickt eine Nachricht ans Board (POST mit --json)
`curl https://rest.fschmalzel.de/api/v1/public/messages -X POST --json '{"author": "NAME", "title": "TITEL", "content": "NACHRICHT"}'`
